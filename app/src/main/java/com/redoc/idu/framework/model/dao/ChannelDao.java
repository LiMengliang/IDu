package com.redoc.idu.framework.model.dao;
...
public class ChannelDao extends AbstractDao<Channel, Long> {
    ...
    public static class Properties {
        ...
        public final static Property CHANNEL_ID = new Property(1, String.class, "CHANNEL_ID", false, "CHANNEL__ID");
        public final static Property CHANNEL_NAME = new Property(2, String.class, "CHANNEL_NAME", false, "CHANNEL__NAME");
        public final static Property CATEGORY_ID = new Property(3, String.class, "CATEGORY_ID", false, "CATEGORY__ID");
        public final static Property CAN_CACHE = new Property(4, Boolean.class, "CAN_CACHE", false, "CAN__CACHE");
        public final static Property FOLLOWED = new Property(5, Boolean.class, "FOLLOWED", false, "FOLLOWED");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CHANNEL\" (" + //
                ...
                "\"CHANNEL__ID\" TEXT," + // 1: CHANNEL_ID
                "\"CHANNEL__NAME\" TEXT," + // 2: CHANNEL_NAME
                "\"CATEGORY__ID\" TEXT," + // 3: CATEGORY_ID
                "\"CAN__CACHE\" INTEGER," + // 4: CAN_CACHE
                "\"FOLLOWED\" INTEGER," + // 5: FOLLOWED
                "\"LINK\" TEXT," + // 6: LINK
    ...
    protected void bindValues(SQLiteStatement stmt, Channel entity) {
        ...
        String CHANNEL_ID = entity.getCHANNEL_ID();
        if (CHANNEL_ID != null) {
            stmt.bindString(2, CHANNEL_ID);
        }
        ...
        if (CAN_CACHE != null) {
            stmt.bindLong(5, CAN_CACHE ? 1L: 0L);
        }

        Boolean FOLLOWED = entity.getFOLLOWED();
        if (FOLLOWED != null) {
            stmt.bindLong(6, FOLLOWED ? 1L: 0L);
        }
    ...
    public Channel readEntity(Cursor cursor, int offset) {
        Channel entity = new Channel( //
                ...
                cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // CHANNEL_ID
                ...
                cursor.isNull(offset + 4) ? null : cursor.getShort(offset + 4) != 0, // CAN_CACHE
                cursor.isNull(offset + 5) ? null : cursor.getShort(offset + 5) != 0, // FOLLOWED
    ...
    public void readEntity(Cursor cursor, Channel entity, int offset) {
        ...
        entity.setCHANNEL_ID(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
        ...
        entity.setCAN_CACHE(cursor.isNull(offset + 4) ? null : cursor.getShort(offset + 4) != 0);
        entity.setFOLLOWED(cursor.isNull(offset + 5) ? null : cursor.getShort(offset + 5) != 0);
