...
import com.redoc.idu.framework.model.dao.CategoryDao;
import com.redoc.idu.framework.model.dao.ChannelDao;
import com.redoc.idu.framework.model.dao.DaoMaster;
import com.redoc.idu.framework.model.dao.DaoSession;
...
class DatabaseManager {
    ...
    private void addChannels() {
        ...
        mChannelDao.insert(new Channel(3L, "T1348648037603", "社会", "1", true, true, "http://c.m.163.com/nc/article/list/T1348648037603/%d-20.html", 3));
        ...
        mChannelDao.insert(new Channel(23L, "T1349837698345", "博客", "1", true, true, "http://c.m.163.com/nc/article/list/T1349837698345/%d-20.html", 23));
